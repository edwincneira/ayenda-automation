...
public class Scroll {
    ...
    public static void scroll(IOSDriver<IOSElement> driver, int init_x, int init_y, int final_x, int final_y) {
    ...
    public static void scrollByRange(IOSDriver<IOSElement> driver, double init_x, double init_y, double final_x, double final_y) {
